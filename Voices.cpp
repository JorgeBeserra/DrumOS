...
void begin() {
  ...
  DrumOS::Synth::createNoise(bufHiHat, SAMPLES_HIHAT, SAMPLE_RATE, 18.0, 18000.0);
  DrumOS::Synth::createNoise(bufCrash, SAMPLES_CRASH, SAMPLE_RATE, 5.0, 20000.0);
  DrumOS::Synth::createTom(bufHiTom, SAMPLES_HITOM, SAMPLE_RATE, 250.0, 150.0, 6.0);
  DrumOS::Synth::createTom(bufLowTom, SAMPLES_LOWTOM, SAMPLE_RATE, 120.0, 60.0, 6.0);
}
